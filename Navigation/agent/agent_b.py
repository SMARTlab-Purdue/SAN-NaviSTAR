...
from crowd_sim.envs.utils.Distance import Distance_to_Wall as Dis


class Agent(object):
    def __init__(self,visible,radius,v_pref,sensor):
        """
    ...
    #     return ObservableState(self.px, self.py, self.vx, self.vy, self.radius,Dis(self.px,self.py).min_distance())
    def get_observable_state(self):
    ...
    #########################################################################################
        # return ObservableState(next_px, next_py, next_vx, next_vy, self.radius,Dis(next_px,next_py).min_distance())
