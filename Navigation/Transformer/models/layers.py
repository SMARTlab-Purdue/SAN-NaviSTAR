...
from src.utils import scaled_Laplacian, cheb_polynomial
import numpy as np
...
#         x = x.permute(0, 1, 3, 2)
        ...
        self.cheb_polynomials = [torch.from_numpy(i).type(torch.FloatTensor).to(self.DEVICE) for i in cheb_polynomial(L_tilde, self.K)] 
