...
########################################################################################################
        # static_obst = [[(-11,-1),(-6.5,-1)],[(-3.5,-1),(3.5,-1)],[(6.5,-1),(11,-1)],[(-10,-1),(-10,-10)],
        #                [(-10,-10),(10,-10)],[(0,-1),(0,-10)],[(10,-1),(10,-10)],[(-11,5),(-8.5,5)],[(-6.5,5),(-3.5,5)],
        #                [(-1.5,5),(1.5,5)],[(3.5,5),(6.5,5)],[(8.5,5),(11,5)],[(-10,10),(10,10)],[(-10,5),(-10,10)],[(-5,5),(-5,10)],[(0,5),(0,10)],
        #                [(5,5),(5,10)],[(10,5),(10,10)]]
###########################################################################################################
...
###########################################################################################################
            # for index_i in range(len(static_obst)):
            #     self.sim.addObstacle(static_obst[index_i])
