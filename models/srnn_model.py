...
class SRNN(nn.Module):
    ...
    def forward(self, inputs, rnn_hxs, masks, infer=False):
        ...
        temporal_edges = reshapeT(inputs['temporal_edges'], seq_length, nenv) # [T, env, 1, 2]
        spatial_edges = reshapeT(inputs['spatial_edges'], seq_length, nenv) # [T, env, 5, 5]
        ...
        hidden_attn_weighted, _ = self.attn(output_temporal, output_spatial) # [T, env_num, 1, 256]
